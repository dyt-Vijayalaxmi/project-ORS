...
//=================Search the product with out input the data=========================
	...
	public static void searchProductNotInputingTheData(String Productname)
	{
		boolean bstatus;
...
//=================Search the product with invalid data =========================
	...
	public static void searchProductInvalidData(String Productname)
	{
		boolean bstatus;
...
//===========search with productname and verify the details of the Product==================
	public static void searchWithProductName(String Productname)
	{
		boolean bstatus;
...
//===========search with CatNo and verify the details of the Product==================
	public static void searchWithCatNo(String CatNo)
	{
		boolean bstatus;
		
		bstatus = setEditIntValue(edit_Name, CatNo);
		Reporter.log(bstatus, "Product Name Entered","Product Name Not Entered");
...
//===========search with CatNo and verify the details of the Product==================
	public static void searchWithCasNo(String CasNo)
	{
		boolean bstatus;
				
		bstatus = setEditIntValue(edit_Name, CasNo);
		Reporter.log(bstatus, "Product Name Entered","Product Name Not Entered");
...
//===========search with CatNo and verify the details of the Product==================
	public static void searchWithSynonym(String Synonym)
	{
		boolean bstatus;
...
//=========================Verify with invalid lotNo in COA Certificate=================
	public static void searchWithInvalidLotNo(String Productname, String LotNo) throws InterruptedException
	{
		boolean bstatus;
		...
		bstatus = setEditIntValue(edit_Lotno, LotNo);
...
//==========================Verify related documents available and able to download=================
	public static void verifyrelateddocumnets(String Productname, String LotNo )
	{
		boolean bstatus;
...
//===============================Verify related products=============================
	public static void verifyrelatedProducts(String Productname)
	{
		boolean bstatus; 
		bstatus = setEditValue(edit_Name, Productname);
		Reporter.log(bstatus, "Product Name Entered","Product Name Not Entered");
...
//===============================Verify related categories=============================
	public static void verifyrelatedCategories(String Productname)
	{
		boolean bstatus; 
		bstatus = setEditValue(edit_Name, Productname);
		Reporter.log(bstatus, "Product Name Entered","Product Name Not Entered");
