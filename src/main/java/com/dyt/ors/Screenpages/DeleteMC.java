...
public class DeleteMC extends BaseClass  {
	...
	public static boolean verifyDeletedMC(String expValue) {
		boolean bStatus = false;
		try {
		List<WebElement> rows = driver.findElements(By.xpath("//table[@id='dataTable']/tbody/tr"));
		int tabrowscount=rows.size();
		...
		if ((actValue.equals(expValue))) { 
			System.out.println("MC is not deleted sucessfully");}
		else {
			System.out.println("MC is deleted sucessfully");
			break;
		}
		}
		}
